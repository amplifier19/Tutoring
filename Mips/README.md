...
- Ένας `Ακέραιος` αριθμός μονής ακρίβειας, καταλαμβάνει μνήμη ίση με `4 bytes` (32 bits). Επομένως στον MIPS, για την δήλωση ενός ακέραιου χρησιμοποιείται το declarative `.word`
- Μία λέξη (word), σε επεξεργαστές όπως ο MIPS, έχει μέγεθος 32 bit, δηλαδή 4 bytes.
